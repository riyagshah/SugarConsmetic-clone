...
import { background, Button, Icon, Select, Stack,Text} from '@chakra-ui/react'
const Navbar = ({flow,setflow,active,setActive,hadleclick, HandleClose,user,setuser, setShow, size }) => {
  ...
  return (
    <div id='nav'>
        <div className='mainBox'>
            ...
            <div className='gif' onClick={() => setShow(true)}>
              <img style={{cursor:"pointer"}} src="https://in.sugarcosmetics.com/desc-images/pride-logo-option.gif" alt="#" />
...
{/* <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-patch-minus-fill" viewBox="0 0 16 16">
...
<a href="###">SKINCARE</a>
    ...
    <div className="topnav" id="myTopnav"><div className="dropdown">
                              {/* orignal link usewd */}
<button className="dropbtn"><a href="https://in.sugarcosmetics.com/pages/offer"> OFFERS </a>    
</button>
</div> </div>
    {/* <h3>STORES</h3> */}
    <div className="topnav" id="myTopnav"><div className="dropdown">
                                 {/* orignal link usewd */}
<button className="dropbtn"><a href="https://in.sugarcosmetics.com/stores"> STORES </a>    
</button>
</div> </div>
</div>
        </div>
